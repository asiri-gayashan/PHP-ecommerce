...
<head>
    ...
    <!-- Page Title -->
    <title>User Profile | Ashirwadha</title>
</head>
...
<body>
                ...
                <ul class="navbar-nav  mb-lg-7">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="collapse " id="orderCollapse">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="./paymentHistroy.php" class="nav-link ">
                                        Payment History
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a href="./cart.php" class="nav-link">
                            ...
                            <span>Cart</span>
                            <span class="badge text-bg-primary rounded-pill ms-auto">12</span>
    ...
    <main class="p-0">
        ...
        <div class="container-fluid p-0">
            ...
            <?php include "peymenthistoryTest.php"; ?>
