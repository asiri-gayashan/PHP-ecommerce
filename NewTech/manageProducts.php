...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3 mb-5 my-5 px-1 px-md-5">
            <div class="col-12 ">
                <div class="row ">

                    <div class="col-12 mb-3">
                        <label class="l-head-title fs-4 fw-bold">Your Products</label>
                    </div>
                        ...
                        <div class="row l-side-card g-0 py-3 px-2 mb-1 mb-lg-3 d-flex ">
                            <div class="col-12 col-lg-6 d-flex align-items-center mb-2">
                                ...
                                <div class=" d-md-none d-flex align-items-baseline">
                                    ...
                                    <a class="btn l-model-btn me-1 bx-sh-none "><i class="bi bi-toggle2-off"></i></a>
                        ...
                        <div class="row l-side-card g-0 py-3 px-2 mb-1 mb-lg-3 d-flex ">
                            <div class="col-12 col-lg-6 d-flex align-items-center mb-2">
                                ...
                                <div class=" d-md-none d-flex align-items-baseline">
                                    ...
                                    <span class="btn l-model-btn me-1 "><i class="bi bi-pencil-square"></i></span>
                                    <span class="btn l-model-btn me-1 "><i class="bi bi-toggle2-off"></i></span>
                                    <span class="btn l-model-btn"><i class="bi bi-trash-fill"></i></span>
